...
namespace InventoryManagement.Api {
    ...
    public partial class ProductDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Name, int CategoryId, decimal Price, int StockQuantity, System.DateTime CreatedAt, decimal Discount) {
...
namespace InventoryManagement.Api.ProductDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_CategoryId = 1 AND [CategoryId] IS NULL) OR ([CategoryId] = @Original_CategoryId)) AND ([Price] = @Original_Price) AND ([StockQuantity] = @Original_StockQuantity) AND ((@IsNull_CreatedAt = 1 AND [CreatedAt] IS NULL) OR ([CreatedAt] = @Original_CreatedAt)) AND ((@IsNull_Discount = 1 AND [Discount] IS NULL) OR ([Discount] = @Original_Discount)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Name], [CategoryId], [Price], [StockQuantity], [CreatedAt], [Discount]) VALUES (@Name, @CategoryId, @Price, @StockQuantity, @CreatedAt, @Discount);
SELECT Id, Name, CategoryId, Price, StockQuantity, CreatedAt, Discount FROM Products WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [CategoryId] = @CategoryId, [Price] = @Price, [StockQuantity] = @StockQuantity, [CreatedAt] = @CreatedAt, [Discount] = @Discount WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_CategoryId = 1 AND [CategoryId] IS NULL) OR ([CategoryId] = @Original_CategoryId)) AND ([Price] = @Original_Price) AND ([StockQuantity] = @Original_StockQuantity) AND ((@IsNull_CreatedAt = 1 AND [CreatedAt] IS NULL) OR ([CreatedAt] = @Original_CreatedAt)) AND ((@IsNull_Discount = 1 AND [Discount] IS NULL) OR ([Discount] = @Original_Discount)));
SELECT Id, Name, CategoryId, Price, StockQuantity, CreatedAt, Discount FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=demodb1.mssql.somee.com;Persist Security Info=True;User ID=novel_SQLL" +
                "ogin_1;Password=bsap6748qv;Encrypt=False;TrustServerCertificate=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, CategoryId, Price, StockQuantity, CreatedAt, Discount FROM dbo.P" +
                "roducts";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, global::System.Nullable<int> Original_CategoryId, decimal Original_Price, int Original_StockQuantity, global::System.Nullable<global::System.DateTime> Original_CreatedAt, global::System.Nullable<decimal> Original_Discount) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> CategoryId, decimal Price, int StockQuantity, global::System.Nullable<global::System.DateTime> CreatedAt, global::System.Nullable<decimal> Discount) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> CategoryId, decimal Price, int StockQuantity, global::System.Nullable<global::System.DateTime> CreatedAt, global::System.Nullable<decimal> Discount, int Original_Id, string Original_Name, global::System.Nullable<int> Original_CategoryId, decimal Original_Price, int Original_StockQuantity, global::System.Nullable<global::System.DateTime> Original_CreatedAt, global::System.Nullable<decimal> Original_Discount, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> CategoryId, decimal Price, int StockQuantity, global::System.Nullable<global::System.DateTime> CreatedAt, global::System.Nullable<decimal> Discount, int Original_Id, string Original_Name, global::System.Nullable<int> Original_CategoryId, decimal Original_Price, int Original_StockQuantity, global::System.Nullable<global::System.DateTime> Original_CreatedAt, global::System.Nullable<decimal> Original_Discount) {
            return this.Update(Name, CategoryId, Price, StockQuantity, CreatedAt, Discount, Original_Id, Original_Name, Original_CategoryId, Original_Price, Original_StockQuantity, Original_CreatedAt, Original_Discount, Original_Id);
        }
    }
